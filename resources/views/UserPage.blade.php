                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="get">
                            <a class="list-group-item list-group-item-action active cat-choose" href="/home">All
                                Categories</a>
                            @foreach ($cats as $cat)
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                            <form action="{{route('home')}}" method="get">
                                @csrf
                                <div class="d-flex">
                                    <input type="text"  name="min" id="" placeholder="Min" style="width:70px; margin-right: 24px; border-color:#ced2d3; border-radius: 10%; height:30px; background-color:#ecf0f1; outline: none; text-align: center;">
                                    <span style="margin-left: -15px;">-</span>
                                    <input type="text"  name="max" id="" placeholder="Max" style="width:70px; border-radius: 10%; border-color:#ced2d3; height:30px; background-color:#ecf0f1; outline: none; text-align: center; margin-left: 8px;">
                                </div>
                                <button type="submit" class="btn mt-3 btn-search"><i class="fa-solid fa-magnifying-glass"></i></button>
                            </form>
                    </div>
                </div>
                        ...
                        @forelse ($meals as $meal)
                            <div class="card rounded shadow-sm border-0"
                                ...
                                <div class="card-body ">
                                    ...
                                    <p class="card-text" style="color: #666;">{{ $meal->description }}</p>
                                    <div
                                        class="card-footer border-0 bg-white p-0 d-flex justify-content-between align-items-center ">
                                        <p class="card-text pull-left mb-0" style="color: #00a8ff;font-weight: bold;">
                                            {{ $meal->price }}&#8378;</p>
                                        <a href="{{ route('cart.add', $meal->id) }}" class="btn btn-primary pull-right add-cart"><i
