        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="{{ asset('loginpage/images/2cd43b_0f15e0cb35494c5ab6ba217a5e26d9d1_mv2.png') }}" alt="IMG">
                </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-center text-light fs-5">{{ __('Register') }}</div>
...
<img src="{{asset('images/signup.jpg')}}" alt="" style="height: 350px;width:350px; position:absolute;left:600px;">
@endsection --}}
